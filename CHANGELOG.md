...
- The card grids of the Bash call, prompt and sub-agent modals take their narrower column and their spacing from one stylesheet rule instead of three inline styles. Internal only: nothing changes on screen.
